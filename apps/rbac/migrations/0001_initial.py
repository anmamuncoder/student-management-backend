    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Auto-generated from resource and action (e.g., product:view).', max_length=100, unique=True)),
                ('resource', models.CharField(help_text='Specify the resource name this permission applies to (e.g., "product", "order").', max_length=50)),
                ('action', models.CharField(help_text='Specify the action type (e.g., view, create, update, delete).', max_length=50)),
